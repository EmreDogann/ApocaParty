...
namespace UI
{
        ...
        IEndDragHandler
    {
        ...
        [FormerlySerializedAs("Interactable")] public bool isEnabled = true;
        [FormerlySerializedAs("Clickable")] public bool isClickable = true;
        [FormerlySerializedAs("Toggleable")] public bool isToggleable;
