...
{
    // From: https://forum.unity.com/threads/flexible-grid-layout.296074/#post-4322734
    /// <summary>
    ...
    public class AutoFlowLayout : LayoutGroup
    {
            ...
            float xOffset, float yOffset, int axis)
        {
            ...
            for (int j = 0; j < _itemList.Count; j++)
            {
                ...
                float rowChildWidth =
                    cellSize.x + extraWidth;       //LayoutUtility.GetPreferredSize(rowChild, 0) + extraWidth;
                float rowChildHeight = cellSize.y; //LayoutUtility.GetPreferredSize(rowChild, 1);
            ...
            float xOffset, float yOffset, int axis)
        {
            ...
            for (int j = 0; j < _itemList.Count; j++)
            {
                ...
                float rowChildWidth = cellSize.x; //LayoutUtility.GetPreferredSize(rowChild, 0) ;
                float rowChildHeight =
