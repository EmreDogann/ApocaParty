...
namespace Utils.Editor
{
    public static class ReverseAnimationContext
    {
        ...
        {
            var animConts = new List<AnimatorController>();
        ...
        private static void ReverseClip(AnimationClip clip, Animator[] animators)
        {
            ...
            {
                var objectReferenceKeyframes = AnimationUtility.GetObjectReferenceCurve(clip, binding);
            ...
            foreach (Animator anim in animators)
            {
                ...
                {
                    Debug.Log(
                        "Found the animator containing the original clip that was reversed, adding new clip to its state machine...");
                    AnimatorController controller =
                        AssetDatabase.LoadAssetAtPath<AnimatorController>(
                            AssetDatabase.GetAssetPath(anim.runtimeAnimatorController));
