...
namespace Editor
{
    ...
    public class LetterBoxerEditor : UnityEditor.Editor
    {
        private SerializedProperty matteColorProp;
        private SerializedProperty referenceModeProp;
        private SerializedProperty xProp;
        private SerializedProperty yProp;
        private SerializedProperty widthProp;
        private SerializedProperty heightProp;
        private SerializedProperty onAwakeProp;
        private SerializedProperty onUpdateProp;
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUILayout.PropertyField(matteColorProp,
                new GUIContent("Matte Color", "The color to use for the matte bars"));
            EditorGUILayout.PropertyField(referenceModeProp,
                new GUIContent("Reference Mode",
                    "Toggles whether you want to use an aspect ratio or a resolution to calculate the letterboxing"));

            LetterBoxer.ReferenceMode currentReferenceMode =
                (LetterBoxer.ReferenceMode)referenceModeProp.enumValueIndex;
            ...
            EditorGUILayout.PropertyField(onAwakeProp,
                new GUIContent("On Awake", "Calculate the letterboxing during OnAwake()"));
            EditorGUILayout.PropertyField(onUpdateProp,
                new GUIContent("On Update", "Calculate the letterboxing during OnUpdate()"));
            EditorGUI.indentLevel--;
